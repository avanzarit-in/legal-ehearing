...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    function analyticsPluginsLoad($ocLazyLoad) {
    ...
    $stateProvider
        ...
        .state('logout', {
          url: "/logout",
          templateUrl: "app/login/login.html",
          data: { pageTitle: 'Login', specialClass: 'gray-bg',  showLogoutMessage: true}
        })
        /* - unused
        ...
        .state('dashboard', {
            ...
            data: { pageTitle: 'Dashboard', specialClass: '' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('supervisor', {
            url: "/supervisor",
            templateUrl: "app/supervisor/supervisor.html",
            data: { pageTitle: 'Supervisor', specialClass: '' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return analyticsPluginsLoad($ocLazyLoad);
                }
            }
        })
        .state('conference', {
            url: "/conference/{docket_id}",
            templateUrl: "app/conference/conference.html",
            data: { pageTitle: 'Hearing', specialClass: '' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('analytics.daily_report', {
			url: "/daily_report",
			templateUrl: "app/analytics/daily_report.html",
